...
export const projectsData = [
  {
    ...
    org: "Arbalest Rocketry Club",
    category: "",
    shortDesc: "Streams live IMU data over UDP to a custom Python ground station for real-time rocket orientation, acceleration, and system health monitoring.",
    caption: "Live hardware demonstration — rotating the IMU updates the rocket orientation in real time.",
    tech: ["Python", "PyQt6", "UDP", "IMU"],
  ...
  },
  {
    ...
    category: "PCB Design",
    githubUrl: "https://github.com/dheeranshankar-del",
    highlights: [
      { label: "CUSTOM PCB", desc: "2-layer STM32F103 design" },
      { label: "DEBUGGING", desc: "SWD programming and debugging" },
      { label: "POWER", desc: "Regulated 3.3V subsystem" },
      { label: "I/O", desc: "GPIO expansion and USB connectivity" }
    ],
    shortDesc: "Designed a custom 2-layer STM32F103 development board for embedded firmware prototyping with USB connectivity, SWD debugging, GPIO expansion, and a regulated 3.3V power subsystem in KiCad.",
    tech: ["STM32F103", "KiCad", "STM32CubeIDE"],
